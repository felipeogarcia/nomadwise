...
// Providers
import { AuthProvider as MockAuthProvider } from '@/stores/useAuthStore'
...
import { OvernightProvider } from '@/stores/useOvernightStore'
...
const OvernightsPage = lazy(() => import('@/pages/trips/OvernightsPage'))
                        ...
                        <Route element={<OnboardingGuard />}>
                          ...
                          <Route element={<Layout />}>
                            <Route path="/app">
                              ...
                              <Route path="trips/:id/overnights" element={<OvernightsPage />} />
