import { a as SelectTrigger, i as SelectItem, l as number$3, n as Select, o as SelectValue, r as SelectContent, s as usePrevious, t as Badge, u as Plus } from "./badge-BO2Z08JV.js";
import { t as Trash2 } from "./trash-2-B_ljEtOH.js";
import { t as Wallet } from "./wallet-DiOx5su2.js";
import { $ as useSize, C as Input, Ct as createContextScope, Dt as toast, Et as composeEventHandlers, H as useFinanceStore, It as require_react, Lt as __commonJSMin, Pt as useSearchParams, Rt as __export, Tt as useComposedRefs, U as useDataStore, d as SheetTrigger, dt as clsx_default, l as SheetHeader, lt as createLucideIcon, nt as formatCurrency, o as Sheet, pt as useControllableState, s as SheetContent, st as LoaderCircle, tt as cn, u as SheetTitle, wt as require_jsx_runtime, yt as Primitive, z as Button, zt as __toESM } from "./index-DbO1TcoC.js";
import { a as CardHeader, n as CardContent, o as CardTitle, t as Card } from "./card-Daq2xIzu.js";
import { a as FormItem, f as object, g as useForm, i as FormField, m as a$1, n as FormControl, o as FormLabel, p as string, r as FormDescription, s as FormMessage, t as Form, u as boolean } from "./form-CpbiUkZ2.js";
import { t as Progress } from "./progress-CYJ0-VRc.js";
import { t as format$1 } from "./format-Bi13BpBv.js";
...
function TripSelector({ value, onChange }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: "Selecione uma viagem" })
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, { children: trips.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
			value: t.id,
			children: t.title
		}, t.id)) })]
	});
...
function BudgetOverview() {
	...
	const { trips } = useDataStore();
	const budget = trips.find((t) => t.id === activeTripId)?.budget || 0;
	const spent = expenses.reduce((sum, exp) => sum + exp.finalAmount, 0);
	const cashSpent = expenses.filter((e) => e.paymentMethod === "cash").reduce((sum, exp) => sum + exp.finalAmount, 0);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
				...
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TrendingDown, { className: "h-4 w-4 text-destructive" })]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
					className: "text-sm font-medium",
					children: "Gasto em Espécie"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Banknote, { className: "h-4 w-4 text-emerald-500" })]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "text-2xl font-bold text-emerald-500",
				children: formatCurrency(cashSpent)
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-xs text-muted-foreground mt-1",
				children: "Impacto direto no caixa"
			})] })] })
		]
	});
}
...
function CategoryManager() {
	...
	const handleAdd = () => {
		...
		const color$1 = COLORS[categories.length % COLORS.length];
		addCategory({
			tripId: activeTripId,
			name,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
		className: "h-full",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, { children: "Categorias" }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
			className: "space-y-6",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [categories.map((cat) => {
					const spent = expenses.filter((e) => e.categoryId === cat.id).reduce((s$1, e) => s$1 + e.finalAmount, 0);
					const pct = Math.min(spent / cat.budget * 100, 100);
					const indColor = pct >= 100 ? "bg-destructive" : pct > 75 ? "bg-amber-500" : "bg-emerald-500";
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "space-y-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
var expenseSchema = object({
	description: string().min(1, "Descrição é obrigatória"),
	amount: number$3().min(.01, "Maior que zero"),
	currency: string().min(1, "Obrigatório"),
	exchangeRate: number$3().min(1e-4, "Taxa inválida"),
	categoryId: string().optional(),
	date: string().min(1, "Obrigatório"),
	paymentMethod: string().min(1, "Obrigatório"),
	iofApplied: boolean().default(false),
	isFuel: boolean().default(false),
	liters: number$3().optional(),
	odometer: number$3().optional()
...
function ExpenseForm() {
	...
	const [isLoadingRate, setIsLoadingRate] = (0, import_react.useState)(false);
	const form = useForm({
		resolver: a$1(expenseSchema),
		defaultValues: {
			description: "",
			amount: 0,
			currency: "BRL",
	...
	const fetchRate = async () => {
		...
		try {
			...
			toast({
				...
				description: `Taxa obtida com sucesso.`
			});
		} catch {
			toast({
				title: "Erro",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Sheet, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTrigger, {
			asChild: true,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { className: "mr-2 h-4 w-4" }), " Nova Despesa"] })
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SheetContent, {
			className: "w-full sm:max-w-md overflow-y-auto",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SheetTitle, { children: "Registrar Despesa" }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Form, {
				...form,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
							...
							name: "description",
							render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, { children: "Descrição" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, { ...field }) })] })
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
								...
								render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
									className: "flex-1",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, { children: "Valor Original" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
										type: "number",
										step: "0.01",
										...field
									}) })]
								...
								render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
									className: "w-24",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, { children: "Moeda" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
						...
						currency !== "BRL" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
								...
								render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
									className: "flex-1",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, { children: "Taxa Câmbio" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
										type: "number",
										step: "0.0001",
										...field
									}) })]
								...
								className: "mb-2",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RefreshCw, { className: cn("h-4 w-4", isLoadingRate && "animate-spin") })
							})]
						}),
						currency !== "BRL" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
							control: form.control,
							name: "iofApplied",
							render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, { children: "Aplicar IOF" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormDescription, { children: "Calcula +5.38% sobre o valor." })]
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
								...
								render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
									className: "flex-1",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, { children: "Categoria" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
										onValueChange: field.onChange,
										defaultValue: field.value,
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: "Selecione" }) }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectContent, { children: categories.map((c$1) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
											value: c$1.id,
											children: c$1.name
										}, c$1.id)) })]
									})]
								...
								render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
									className: "flex-1",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, { children: "Método" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
										onValueChange: field.onChange,
										defaultValue: field.value,
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, {}) }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectContent, { children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
							...
							name: "isFuel",
							render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
								className: "flex justify-between items-center rounded-lg border p-4 bg-muted/20",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "space-y-0.5",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, { children: "É abastecimento?" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormDescription, { children: "Habilita métricas de combustível." })]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Switch, {
									checked: field.value,
									onCheckedChange: field.onChange
								}) })]
						...
						isFuel && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex gap-4",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
								control: form.control,
								name: "liters",
								render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
									className: "flex-1",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, { children: "Litros" }),
								...
								render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, {
									className: "flex-1",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, { children: "Odômetro" }),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormControl, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
											type: "number",
											...field,
											value: field.value || ""
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "p-4 bg-primary/10 rounded-lg text-center my-6",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-sm text-muted-foreground block mb-1",
								children: "Custo Final Estimado (BRL)"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-2xl font-bold text-primary",
								children: formatCurrency(previewAmount)
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							type: "submit",
...
function ExpenseList() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, { children: "Histórico de Despesas" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExpenseForm, {})]
			...
			] }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableBody, { children: expenses.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableRow, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
				colSpan: 5,
				className: "text-center py-8 text-muted-foreground",
				children: "Nenhuma despesa registrada."
			}) }) : expenses.map((exp) => {
				const cat = categories.find((c$1) => c$1.id === exp.categoryId);
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
						className: "text-xs text-muted-foreground whitespace-nowrap",
						children: format$1(new Date(exp.date), "dd/MM/yy HH:mm")
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableCell, {
						className: "font-medium",
						children: [exp.description, exp.isFuel && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
							variant: "outline",
							className: "ml-2 text-[10px]",
							children: "Combustível"
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, { children: cat ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
						style: {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
						...
						children: formatCurrency(exp.finalAmount)
					}),
...
var require__stringToPath = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var reEscapeChar = /\\(\\)?/g;
	module.exports = memoizeCapped(function(string$1) {
		var result = [];
		if (string$1.charCodeAt(0) === 46) result.push("");
		string$1.replace(rePropName, function(match, number$4, quote, subString) {
			result.push(quote ? subString.replace(reEscapeChar, "$1") : number$4 || match);
		});
		return result;
	});
}));
...
var require__hasUnicode = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function hasUnicode$2(string$1) {
...
var require__asciiToArray = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	function asciiToArray$1(string$1) {
...
var require__unicodeToArray = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function unicodeToArray$1(string$1) {
...
var require__stringToArray = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function stringToArray$1(string$1) {
		return hasUnicode$1(string$1) ? unicodeToArray(string$1) : asciiToArray(string$1);
	}
...
function controlPoints(x$1) {
	var i, n = x$1.length - 1, m, a$2 = new Array(n), b = new Array(n), r = new Array(n);
	a$2[0] = 0, b[0] = 2, r[0] = x$1[0] + 2 * x$1[1];
	for (i = 1; i < n - 1; ++i) a$2[i] = 1, b[i] = 4, r[i] = 4 * x$1[i] + 2 * x$1[i + 1];
	a$2[n - 1] = 2, b[n - 1] = 7, r[n - 1] = 8 * x$1[n - 1] + x$1[n];
	for (i = 1; i < n; ++i) m = a$2[i] / b[i - 1], b[i] -= m, r[i] -= m * r[i - 1];
	a$2[n - 1] = r[n - 1] / b[n - 1];
	for (i = n - 2; i >= 0; --i) a$2[i] = (r[i] - a$2[i + 1]) / b[i];
	b[n - 1] = (x$1[n] + a$2[n - 1]) / 2;
	for (i = 0; i < n - 1; ++i) b[i] = 2 * x$1[i + 1] - a$2[i + 1];
	return [a$2, b];
}
...
var require__baseSetToString = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = !defineProperty$1 ? identity$7 : function(func, string$1) {
...
function _iterableToArrayLimit$11(r, l) {
	...
	if (null != t) {
		var e, n, i, u, a$2 = [], f = !0, o = !1;
		try {
			if (i = (t = t.call(r)).next, 0 === l) {
				if (Object(t) !== t) return;
				f = !1;
			} else for (; !(f = (e = i.call(t)).done) && (a$2.push(e.value), a$2.length !== l); f = !0);
		} catch (r$1) {
			o = !0, n = r$1;
		} finally {
			try {
...
var require__trimmedEndIndex = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var reWhitespace = /\s/;
	function trimmedEndIndex$1(string$1) {
...
function bisector(f) {
	...
	function center(a$2, x$1, lo = 0, hi = a$2.length) {
		const i = left(a$2, x$1, lo, hi - 1);
		return i > lo && delta(a$2[i - 1], x$1) > -delta(a$2[i], x$1) ? i - 1 : i;
	}
	return {
		left,
		center,
...
function rgba(r, g, b, a$2) {
	if (a$2 <= 0) r = g = b = NaN;
	return new Rgb(r, g, b, a$2);
}
...
function hsla(h, s$1, l, a$2) {
	if (a$2 <= 0) h = s$1 = l = NaN;
	else if (l <= 0 || l >= 1) h = s$1 = NaN;
	else if (s$1 <= 0) h = NaN;
	return new Hsl(h, s$1, l, a$2);
}
...
function exponential(a$2, b, y$1) {
	return a$2 = Math.pow(a$2, y$1), b = Math.pow(b, y$1) - a$2, y$1 = 1 / y$1, function(t) {
		return Math.pow(a$2 + t * b, y$1);
	};
}
function gamma(y$1) {
...
function numberArray_default(a$2, b) {
	if (!b) b = [];
	var n = a$2 ? Math.min(b.length, a$2.length) : 0, c$1 = b.slice(), i;
	return function(t) {
		for (i = 0; i < n; ++i) c$1[i] = a$2[i] * (1 - t) + b[i] * t;
		return c$1;
	};
}
...
function genericArray(a$2, b) {
	var nb = b ? b.length : 0, na = a$2 ? Math.min(nb, a$2.length) : 0, x$1 = new Array(na), c$1 = new Array(nb), i;
	for (i = 0; i < na; ++i) x$1[i] = value_default(a$2[i], b[i]);
...
function date_default(a$2, b) {
	...
	return a$2 = +a$2, b = +b, function(t) {
		return d.setTime(a$2 * (1 - t) + b * t), d;
	};
}
...
function object_default(a$2, b) {
	...
	for (k$1 in b) if (k$1 in a$2) i[k$1] = value_default(a$2[k$1], b[k$1]);
	else c$1[k$1] = b[k$1];
	return function(t) {
...
function formatLocale(locale$2) {
	...
	function newFormat(specifier, formats$1) {
		return function(date$1) {
			var string$1 = [], i = -1, j = 0, n = specifier.length, c$1, pad$1, format$2;
			if (!(date$1 instanceof Date)) date$1 = /* @__PURE__ */ new Date(+date$1);
			while (++i < n) if (specifier.charCodeAt(i) === 37) {
				string$1.push(specifier.slice(j, i));
	...
	function newParse(specifier, Z) {
		return function(string$1) {
			var d = newDate(1900, void 0, 1), i = parseSpecifier(d, specifier, string$1 += "", 0), week, day;
			if (i != string$1.length) return null;
	...
	function parseSpecifier(d, specifier, string$1, j) {
		var i = 0, n = specifier.length, m = string$1.length, c$1, parse;
		while (i < n) {
			if (j >= m) return -1;
			...
			if (c$1 === 37) {
				...
				if (!parse || (j = parse(d, string$1, j)) < 0) return -1;
			} else if (c$1 != string$1.charCodeAt(j++)) return -1;
		}
		return j;
	}
	function parsePeriod(d, string$1, i) {
		var n = periodRe.exec(string$1.slice(i));
		return n ? (d.p = periodLookup.get(n[0].toLowerCase()), i + n[0].length) : -1;
	}
	function parseShortWeekday(d, string$1, i) {
		var n = shortWeekdayRe.exec(string$1.slice(i));
		return n ? (d.w = shortWeekdayLookup.get(n[0].toLowerCase()), i + n[0].length) : -1;
	}
	function parseWeekday(d, string$1, i) {
		var n = weekdayRe.exec(string$1.slice(i));
		return n ? (d.w = weekdayLookup.get(n[0].toLowerCase()), i + n[0].length) : -1;
	}
	function parseShortMonth(d, string$1, i) {
		var n = shortMonthRe.exec(string$1.slice(i));
		return n ? (d.m = shortMonthLookup.get(n[0].toLowerCase()), i + n[0].length) : -1;
	}
	function parseMonth(d, string$1, i) {
		var n = monthRe.exec(string$1.slice(i));
		return n ? (d.m = monthLookup.get(n[0].toLowerCase()), i + n[0].length) : -1;
	}
	function parseLocaleDateTime(d, string$1, i) {
		return parseSpecifier(d, locale_dateTime, string$1, i);
	}
	function parseLocaleDate(d, string$1, i) {
		return parseSpecifier(d, locale_date, string$1, i);
	}
	function parseLocaleTime(d, string$1, i) {
		return parseSpecifier(d, locale_time, string$1, i);
	}
...
function pad(value, fill, width) {
	var sign$1 = value < 0 ? "-" : "", string$1 = (sign$1 ? -value : value) + "", length = string$1.length;
	return sign$1 + (length < width ? new Array(width - length + 1).join(fill) + string$1 : string$1);
}
...
function parseWeekdayNumberSunday(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 1));
	return n ? (d.w = +n[0], i + n[0].length) : -1;
}
function parseWeekdayNumberMonday(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 1));
	return n ? (d.u = +n[0], i + n[0].length) : -1;
}
function parseWeekNumberSunday(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 2));
	return n ? (d.U = +n[0], i + n[0].length) : -1;
}
function parseWeekNumberISO(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 2));
	return n ? (d.V = +n[0], i + n[0].length) : -1;
}
function parseWeekNumberMonday(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 2));
	return n ? (d.W = +n[0], i + n[0].length) : -1;
}
function parseFullYear(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 4));
	return n ? (d.y = +n[0], i + n[0].length) : -1;
}
function parseYear(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 2));
	return n ? (d.y = +n[0] + (+n[0] > 68 ? 1900 : 2e3), i + n[0].length) : -1;
}
function parseZone(d, string$1, i) {
	var n = /^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec(string$1.slice(i, i + 6));
	return n ? (d.Z = n[1] ? 0 : -(n[2] + (n[3] || "00")), i + n[0].length) : -1;
}
function parseQuarter(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 1));
	return n ? (d.q = n[0] * 3 - 3, i + n[0].length) : -1;
}
function parseMonthNumber(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 2));
	return n ? (d.m = n[0] - 1, i + n[0].length) : -1;
}
function parseDayOfMonth(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 2));
	return n ? (d.d = +n[0], i + n[0].length) : -1;
}
function parseDayOfYear(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 3));
	return n ? (d.m = 0, d.d = +n[0], i + n[0].length) : -1;
}
function parseHour24(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 2));
	return n ? (d.H = +n[0], i + n[0].length) : -1;
}
function parseMinutes(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 2));
	return n ? (d.M = +n[0], i + n[0].length) : -1;
}
function parseSeconds(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 2));
	return n ? (d.S = +n[0], i + n[0].length) : -1;
}
function parseMilliseconds(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 3));
	return n ? (d.L = +n[0], i + n[0].length) : -1;
}
function parseMicroseconds(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i, i + 6));
	return n ? (d.L = Math.floor(n[0] / 1e3), i + n[0].length) : -1;
}
function parseLiteralPercent(d, string$1, i) {
	var n = percentRe.exec(string$1.slice(i, i + 1));
	return n ? i + n[0].length : -1;
}
function parseUnixTimestamp(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i));
	return n ? (d.Q = +n[0], i + n[0].length) : -1;
}
function parseUnixTimestampSeconds(d, string$1, i) {
	var n = numberRe.exec(string$1.slice(i));
	return n ? (d.s = +n[0], i + n[0].length) : -1;
}
	...
	(function(globalScope) {
		...
		var divide = (function() {
			...
			function compare(a$2, b, aL, bL) {
				...
				else for (i = r = 0; i < aL; i++) if (a$2[i] != b[i]) {
					r = a$2[i] > b[i] ? 1 : -1;
					break;
				}
				return r;
...
var arithmetic_default = {
	rangeStep,
	getDigitCount,
	interpolateNumber: curry(function(a$2, b, t) {
		var newA = +a$2;
...
function Label(_ref4) {
	...
	if (!viewBox || (0, import_isNil$4.default)(value) && (0, import_isNil$4.default)(children) && !/* @__PURE__ */ (0, import_react.isValidElement)(content) && !(0, import_isFunction$12.default)(content)) return null;
...
function LabelList(_ref) {
	...
	return /* @__PURE__ */ import_react.createElement(Layer, { className: "recharts-label-list" }, data.map(function(entry, index) {
		...
		return /* @__PURE__ */ import_react.createElement(Label, _extends$18({}, filterProps(entry, true), others, idProps, {
			...
			value,
			textBreakAll,
			viewBox: Label.parseViewBox((0, import_isNil$3.default)(clockWise) ? entry : _objectSpread$23(_objectSpread$23({}, entry), {}, { clockWise })),
			key: "label-".concat(index),
			index
		}));
	}));
...
function combineComparators(comparatorA, comparatorB) {
	return function isEqual$5(a$2, b, state) {
...
function createIsEqual({ circular, comparator, createState, equals, strict }) {
	if (createState) return function isEqual$5(a$2, b) {
	...
	if (circular) return function isEqual$5(a$2, b) {
		return comparator(a$2, b, {
	...
	return function isEqual$5(a$2, b) {
...
function renderLineItem(option, props) {
	...
	else if ((0, import_isFunction$2.default)(option)) lineItem = option(props);
	else {
...
function CartesianGrid(props) {
	...
	if ((!horizontalPoints || !horizontalPoints.length) && (0, import_isFunction$2.default)(horizontalCoordinatesGenerator)) {
	...
	if ((!verticalPoints || !verticalPoints.length) && (0, import_isFunction$2.default)(verticalCoordinatesGenerator)) {
...
function FuelSummary() {
	...
	const chartData = (0, import_react.useMemo)(() => {
		const fuelExps = expenses.filter((e) => e.isFuel && e.odometer && e.liters).sort((a$2, b) => (a$2.odometer || 0) - (b.odometer || 0));
		const data = [];
		for (let i = 1; i < fuelExps.length; i++) {
			const prev = fuelExps[i - 1];
			const curr = fuelExps[i];
			const eff = ((curr.odometer || 0) - (prev.odometer || 0)) / (curr.liters || 1);
			if (eff > 0 && eff < 100) data.push({
	...
	const chartConfig = { efficiency: {
		label: "Eficiência (km/L)",
		color: "hsl(var(--primary))"
	} };
	const avgEff = chartData.reduce((s$1, d) => s$1 + d.efficiency, 0) / chartData.length;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
		className: "flex flex-row items-center justify-between pb-2",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
			className: "flex items-center gap-2",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Activity, { className: "h-5 w-5 text-primary" }), "Evolução de Consumo"]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
...
function FinancesPage() {
	...
	(0, import_react.useEffect)(() => {
		if (defaultTripId && defaultTripId !== activeTripId) {
			...
			if (!tripIdFromUrl) setSearchParams({ trip: defaultTripId }, { replace: true });
		}
	}, [
		defaultTripId,
		activeTripId,
	...
	if (!defaultTripId) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "text-center p-12 text-muted-foreground",
		children: "Nenhuma viagem encontrada. Por favor, crie uma viagem primeiro."
	});
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				...
				children: "Finanças"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TripSelector, {
				value: activeTripId || defaultTripId,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BudgetOverview, {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FuelSummary, {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "grid grid-cols-1 lg:grid-cols-12 gap-6",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "lg:col-span-4",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CategoryManager, {})
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "lg:col-span-8",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExpenseList, {})
				})]
			})
		] })]
	});
}
export { FinancesPage as default };

//# sourceMappingURL=FinancesPage-DBqyY_1F.js.map